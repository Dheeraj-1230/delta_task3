         ...
         <li>
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a  data-toggle="collapse" data-target="#posts_dropdown"><i class="fa fa-fw fa-arrows-v"></i> Events <i class="fa fa-fw fa-caret-down"></i></a>
                        <ul >
                            <li>
                    ...
                    <li>
                        <a  data-toggle="collapse" data-target="#dropdown"><i class="fa fa-fw fa-arrows-v"></i> Invitations <i class="fa fa-fw fa-caret-down"></i></a>
                        <ul >
                            <li>
